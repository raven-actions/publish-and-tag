...
import makeReleaseLatest from './make-release-latest'
import getTagName from './get-tag-name'
import * as getGit from './get-git'
import getRewriteTags from './get-rewrite-tags'
import getMakeLatest from './get-make-latest'
import getCleanupManifest from './get-cleanup-manifest'
import cleanupActionManifest from './cleanup-action-manifest'
